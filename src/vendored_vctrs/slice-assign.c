...
r_obj* vec_assign_opts(r_obj* x,
  ...
  struct vendored_vctrs_arg* x_arg = r_lazy_is_null(p_opts->call) ? vec_args.x : p_opts->x_arg;
  struct vendored_vctrs_arg* value_arg = r_lazy_is_null(p_opts->call) ? vec_args.value : p_opts->value_arg;
...
r_obj* ffi_assign(
  ...
  struct vendored_vctrs_arg value_arg = new_lazy_arg(&value_arg_lazy);
...
void check_recyclable_against_index(
  ...
  enum assignment_slice_value slice_value,
  enum vctrs_index_style index_style,
  struct vendored_vctrs_arg* p_value_arg,
  struct r_lazy call
) {
  r_ssize check_size;
