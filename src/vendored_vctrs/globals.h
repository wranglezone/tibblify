...
struct vec_args {
  struct vendored_vctrs_arg* dot_name_repair;
  struct vendored_vctrs_arg* dot_ptype;
  struct vendored_vctrs_arg* dot_size;
  struct vendored_vctrs_arg* empty;
  struct vendored_vctrs_arg* i;
  struct vendored_vctrs_arg* max_fill;
  struct vendored_vctrs_arg* n;
  struct vendored_vctrs_arg* value;
  struct vendored_vctrs_arg* x;
  struct vendored_vctrs_arg* y;
  struct vendored_vctrs_arg* indices;
  struct vendored_vctrs_arg* sizes;
  struct vendored_vctrs_arg* ptype;
  struct vendored_vctrs_arg* size;
};
