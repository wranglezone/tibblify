...
r_obj* ffi_tib_ptype2(r_obj* x,
                      ...
                      r_obj* ffi_y_arg_,
                      r_obj* frame) {
  struct vendored_vctrs_arg x_arg = vendored_vec_as_arg(ffi_x_arg_);
  struct vendored_vctrs_arg y_arg = vendored_vec_as_arg(ffi_y_arg_);
...
r_obj* ffi_tib_cast(r_obj* x,
                    ...
                    r_obj* ffi_to_arg,
                    r_obj* frame) {
  struct vendored_vctrs_arg x_arg = vendored_vec_as_arg(ffi_x_arg);
  struct vendored_vctrs_arg to_arg = vendored_vec_as_arg(ffi_to_arg);
