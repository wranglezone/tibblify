...
r_obj* ffi_vec_rep(r_obj* x, r_obj* ffi_times, r_obj* frame) {
  ...
  struct vendored_vctrs_arg x_arg = new_lazy_arg(&x_arg_lazy);

  struct r_lazy times_arg_lazy = { .x = syms.times_arg, .env = frame };
  struct vendored_vctrs_arg times_arg = new_lazy_arg(&times_arg_lazy);
...
static inline
void stop_rep_times_negative(struct r_lazy call, struct vendored_vctrs_arg* p_times_arg) {
...
static inline
void stop_rep_times_missing(struct r_lazy call, struct vendored_vctrs_arg* p_times_arg) {
  r_abort_lazy_call(call,
                    "%s can't be missing.",
                    vec_arg_format(p_times_arg));
}
...
static inline
void stop_rep_times_oob(int times, struct r_lazy call, struct vendored_vctrs_arg* p_times_arg) {
  r_abort_lazy_call(
    call,
...
static inline
void stop_rep_each_times_negative(r_ssize i, struct r_lazy call, struct vendored_vctrs_arg* p_times_arg) {
  r_abort_lazy_call(call,
...
static inline
void stop_rep_each_times_missing(r_ssize i, struct r_lazy call, struct vendored_vctrs_arg* p_times_arg) {
  r_abort_lazy_call(call,
...
// long vectors are supported
static inline
void stop_rep_each_times_oob(int times, r_ssize i, struct r_lazy call, struct vendored_vctrs_arg* p_times_arg) {
  r_abort_lazy_call(
    call,
    "%s must be less than %i, not %i. ",
