#ifndef VENDORED_VCTRS_H
#define VENDORED_VCTRS_H
...
r_obj* vec_ptype(r_obj* x, struct vendored_vctrs_arg* x_arg, struct r_lazy call);
...
SEXP vec_match_params(SEXP needles,
                      SEXP haystack,
                      bool na_equal,
                      struct vendored_vctrs_arg* needles_arg,
                      struct vendored_vctrs_arg* haystack_arg,
                      struct r_lazy call);
...
SEXP vec_in(
  ...
  SEXP haystack,
  bool na_equal,
  struct vendored_vctrs_arg* p_needles_arg,
  struct vendored_vctrs_arg* p_haystack_arg,
  struct r_lazy call
);
...
SEXP chr_as_factor(SEXP x, SEXP to, bool* lossy, struct vendored_vctrs_arg* to_arg);
SEXP chr_as_ordered(SEXP x, SEXP to, bool* lossy, struct vendored_vctrs_arg* to_arg);

SEXP fct_as_character(SEXP x, struct vendored_vctrs_arg* x_arg);
SEXP fct_as_factor(SEXP x, SEXP to, bool* lossy, struct vendored_vctrs_arg* x_arg, struct vendored_vctrs_arg* to_arg);

SEXP ord_as_character(SEXP x, struct vendored_vctrs_arg* x_arg);
