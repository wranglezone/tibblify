...
static inline struct vendored_vctrs_arg vendored_vec_as_arg(SEXP x) {
  if (x == R_NilValue) {
...
extern SEXP vendored_strings_empty;
...
extern SEXP vendored_syms_value;
...
extern SEXP vendored_syms_ptype;
