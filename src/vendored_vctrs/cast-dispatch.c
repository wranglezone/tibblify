...
r_obj* vec_cast_dispatch_native(const struct cast_opts* opts,
  ...
  r_obj* x = opts->x;
  r_obj* to = opts->to;
  struct vendored_vctrs_arg* x_arg = opts->p_x_arg;
  struct vendored_vctrs_arg* to_arg = opts->p_to_arg;
...
r_obj* ffi_cast_dispatch_native(r_obj* x,
                                ...
                                r_obj* to_arg,
                                r_obj* frame) {
  struct vendored_vctrs_arg c_x_arg = vendored_vec_as_arg(x_arg);
  struct vendored_vctrs_arg c_to_arg = vendored_vec_as_arg(to_arg);
