...
void stop_corrupt_factor_levels(SEXP x, struct vendored_vctrs_arg* arg) r_no_return;
void stop_corrupt_ordered_levels(SEXP x, struct vendored_vctrs_arg* arg) r_no_return;
