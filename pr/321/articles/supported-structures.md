...
to make it easier and more robust to convert lists of lists into
...
e.g. [`tib_lgl_vec()`](https://tibblify.wrangle.zone/reference/tib_spec.md).
...
[`tib_vector()`](https://tibblify.wrangle.zone/reference/tib_spec.md) to
parse them:
...
[`tib_vector()`](https://tibblify.wrangle.zone/reference/tib_spec.md) to
parse them. To store the names use the `.names_to` and `.values_to`
arguments.
...
They can be parsed with
[`tib_row()`](https://tibblify.wrangle.zone/reference/tib_spec.md). For
example:
...
[`tib_df()`](https://tibblify.wrangle.zone/reference/tib_spec.md), but
you can parse the names into an extra column via the `.names_to`
argument:
