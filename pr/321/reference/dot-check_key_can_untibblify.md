...
[`.check_key_length_1()`](https://tibblify.wrangle.zone/reference/dot-check_key_length_1.md)
and
[`.check_key_is_character()`](https://tibblify.wrangle.zone/reference/dot-check_key_is_character.md).
