...
Source:
[`DESCRIPTION`](https://github.com/wranglezone/tibblify/blob/copilot/treat-empties-as-empty-for-vector/DESCRIPTION)

Harmon J, Girlich M (2026). *tibblify: Rectangle Nested Lists*. R
package version 0.4.1.9000, <https://tibblify.wrangle.zone>.
