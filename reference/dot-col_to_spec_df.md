...
Delegates to
[`.list_of_col_to_spec_df()`](https://tibblify.wrangle.zone/reference/dot-list_of_col_to_spec_df.md)
or
[`.non_list_of_col_to_spec_df()`](https://tibblify.wrangle.zone/reference/dot-non_list_of_col_to_spec_df.md)
...
A [`tib_df()`](https://tibblify.wrangle.zone/reference/tib_spec.md)
specification.
